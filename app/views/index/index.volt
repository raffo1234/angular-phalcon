<div class="wrapper_home height_100" ng-controller="homeCtrl">
    ...
    {#<div class="cover_loading cover_loading_js align_center" >
        <div class="helper"></div><!--
        --><div class="cover display-inline cover_logo_js">
            <div class="helper"></div><!--
            --><a href="/" class="display-inline" ng-click="clickMenuList($event)">
                <img ng-src="assets/images/logo.png" width="107" class="display-inline logo" alt="Rafael Meza" logoonload />
            </a>
        </div>
    </div>#}
